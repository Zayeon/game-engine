...
public class ParticleRenderer {
	...
	private void bindTexture(ParticleTexture texture){
        ...
        if (texture.isAdditive()){
            GL11.glBlendFunc(GL11.GL_SRC_ALPHA, GL11.GL_ONE); // can use GL_ONE or GL_ONE_MINUS_SRC_ALPHA
        }else{
            GL11.glBlendFunc(GL11.GL_SRC_ALPHA, GL11.GL_ONE_MINUS_SRC_ALPHA); // can use GL_ONE or GL_ONE_MINUS_SRC_ALPHA
        }
