...
public class Loader {
	...
	public int loadTexture(String fileName){
        return loadGenericTexture("res/textures/"+fileName+".png");
    }

    public int loadUtilTexture(String fileName){
        return loadGenericTexture("res/util/"+fileName+".png");
    }

    public int loadFontTexture(String fileName){
        return loadGenericTexture("res/font/"+fileName+".png");
    }

    public int loadParticleTexture(String fileName){
        return loadGenericTexture("res/particles/" + fileName + ".png");
    }

    public int loadCubeMap(String[] textureFiles){
		// ORDER OF TEXTURE FILES: right, left, top, bottom, back, front
	...
	private int loadGenericTexture(String filePath){
        ...
        if(NewDisplayManager.getCapabilities().GL_EXT_texture_filter_anisotropic){
